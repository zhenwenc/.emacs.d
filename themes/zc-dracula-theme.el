...
(def-doom-theme zc-dracula
  ...
  ((bg         '("#282a36" nil       nil            ))
   ...
   (level1 magenta)
   (level2 violet)
   (level3 (doom-lighten violet 0.35))
   (level4 (doom-lighten magenta 0.35))
   (level5 (doom-lighten violet 0.6))
   (level6 (doom-lighten magenta 0.6))
   (level7 (doom-lighten violet 0.85))
   (level8 (doom-lighten magenta 0.85))
   (level9 (doom-lighten violet 0.95))
